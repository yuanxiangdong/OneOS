...
public class OneOSStickyGridAdapter extends LocalFileBaseAdapter implements StickyGridHeadersSimpleAdapter {

    private String[] mSectionLetters;

    public OneOSStickyGridAdapter(Context context, List<File> fileList, ArrayList<File> selectedList, OnMultiChooseClickListener listener) {
