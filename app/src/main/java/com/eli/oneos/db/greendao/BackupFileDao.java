...
/** 
 * DAO for table BACKUP_ALBUM.
*/
public class BackupFileDao extends AbstractDao<BackupFile, Long> {

    public static final String TABLENAME = "BACKUP_ALBUM";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'BACKUP_ALBUM' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'BACKUP_ALBUM'";
        db.execSQL(sql);
    }
